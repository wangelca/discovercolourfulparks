    ...
    Alberta: [
      {
        ...
        description:
          "The natural beauty of Banffs surrounding lakes and mountains made it Canadas first National Park and the worlds third national park refuge, and part of the Canadian Rocky Mountain Parks UNESCO World Heritage Site. More than 4 million people from around the world now visit Banff National Park every year.",
        image: "/banff_parks.jpg",
      },
      {
        name: "Jasper National Park",
        description:
          "Spanning over 11,000 square kilometers, Jasper is the largest national park in the Canadian Rockies. Known for its vast wilderness, majestic peaks, abundant wildlife, and outstanding beauty, visitors from all over Canada and round the world travel here to experience this very special place.",
        image: "/jasper_parks.jpg",
      },
      {
        name: "Elk Island National Park",
        description:
          "Elk Island is home to the densest population of ungulates (hoofed mammals) in Canada. A variety of mammal species including coyote, bison, moose, mule deer, lynx, beaver, elk, white-tailed deer, and porcupine are year round residents.",
        image: "/elkisland_parks.jpg",
      },
      {
